...
- [x] 1. Create path resolution module with configurable root directory
...
- [x] 2. Update configuration handling for configurable root directory
...
- [x] 3. Update database operations for relative path storage
...
- [x] 4. Update handlers for relative path processing
...
- [x] 5. Integrate PathResolver throughout application
...
- [x] 6. Update configuration file format
